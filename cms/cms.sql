...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2017 at 12:00 PM
...
CREATE TABLE IF NOT EXISTS `comments` (
  `comment_id` int(55) NOT NULL AUTO_INCREMENT,
  `comment_post_id` int(55) NOT NULL,
...
(1, 2, '2017-01-05', 'Julius Kiano', 'j@gmail.com', 'This is such an awesome post', 'unapproved'),
(5, 5, '2017-01-05', 'TheAnimeGuy', 'anime@anime.com', 'This guy is also OP, but really cool. Firest anime i''ve ever watched.', 'unapproved'),
(6, 2, '2017-01-05', 'luffyGroopie', 'groupie@luffy.com', 'OMG!!! YAASSSSSSSSSS', 'unapproved'),
(7, 5, '2017-01-05', 'TheAnimeGuy', 'anime@anime.com', 'NARUTO FTW', 'unapproved'),
(8, 2, '2017-01-05', 'TheAnimeGuy', 'anime@anime.com', 'LUFFY FTW', 'unapproved');
